...
class create_database_test(unittest.TestCase):
    ...
    def test_database_has_all_tables(self):
        ...
        self.assertTrue(
            all(expected in real_tables for expected in expected_tables))
    ...
    def test_run_columns(self):
        ...
        self.assertTrue(
            all(expected in real_columns for expected in expected_columns))
    ...
    def test_responded_columns(self):
        expected_columns = [
            'empNumber', 'runNumber', 'date', 'payRate', 'type_of_response',
            'full_time', 'subhours'
        ]
        real_columns = []
        cur = create_database_test.conn.cursor()
